...
/* =========================
   TERRAIN + WASSER
========================= */
loader.load("bilder/hoehenkarte_de.png", (heightTexture) => {
  ...
  seaSlider.addEventListener("input", () => {
    ...
    if (level < 0.8) {
      impactText.textContent = "Geringe Auswirkungen – Küstenschutz ist möglich.";
    } else if (level < 1.6) {
      impactText.textContent = "Erste Städte werden regelmäßig überflutet.";
    } else {
      impactText.textContent = "Große Teile der Küste sind dauerhaft bedroht.";
    }
  });
});
